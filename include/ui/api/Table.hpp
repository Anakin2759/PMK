...
inline constexpr EntityAction<static_cast<void (*)(ui::entity, int, std::vector<std::string>)>(
    &ui::table::SetColumns)>
    SET_COLUMNS_ACTION{};
inline constexpr EntityAction<static_cast<void (*)(ui::entity, std::vector<float>)>(
    &ui::table::SetColumnWidths)>
    SET_COLUMN_WIDTHS_ACTION{};
inline constexpr EntityAction<static_cast<void (*)(ui::entity, std::vector<std::string>)>(
    &ui::table::AddRow)>
    ADD_ROW_ACTION{};
inline constexpr EntityAction<static_cast<void (*)(ui::entity)>(&ui::table::ClearRows)>
    CLEAR_ROWS_ACTION{};
inline constexpr EntityAction<static_cast<void (*)(ui::entity, int)>(&ui::table::SetSelectedRow)>
    SET_SELECTED_ROW_ACTION{};
inline constexpr EntityAction<static_cast<void (*)(ui::entity, int, int, ui::entity)>(
