...
{
    const auto dropDown = factory::CreateDropDown(runtime(), {"A", "B"}, 0, "theme_dropdown_states");
...
{
    const auto owner = factory::CreateDropDown(runtime(), {"A", "B", "C"}, 0, "theme_dropdown_popup_owner");
    const auto popupPanelResult = factory::CreateBaseWidget(runtime(), "theme_dropdown_popup_panel");
    ...
    const auto selectedItemResult = factory::CreateBaseWidget(runtime(), "theme_dropdown_popup_item_selected");
    ...
    const auto hoveredItemResult = factory::CreateBaseWidget(runtime(), "theme_dropdown_popup_item_hovered");
    ...
    const auto idleItemResult = factory::CreateBaseWidget(runtime(), "theme_dropdown_popup_item_idle");
    ...
    hierarchy::AddChild(runtime(), popupPanel, selectedItem);
    hierarchy::AddChild(runtime(), popupPanel, hoveredItem);
    hierarchy::AddChild(runtime(), popupPanel, idleItem);
...
{
    const auto owner = factory::CreateDropDown(runtime(), {"A", "B"}, 0, "theme_dropdown_popup_geometry_owner");
    const auto popupPanelResult = factory::CreateBaseWidget(runtime(), "theme_dropdown_popup_geometry_panel");
    ASSERT_TRUE(popupPanelResult.has_value()) << popupPanelResult.error().ToString();
    const auto popupPanel = popupPanelResult->raw;
    registry().emplace<components::DropDownPopupPanel>(popupPanel).owner = detail::ToInternal(owner);

    const auto popupItemResult = factory::CreateBaseWidget(runtime(), "theme_dropdown_popup_geometry_item");
    ...
    hierarchy::AddChild(runtime(), popupPanel, popupItem);
