...
namespace detail
{
inline ui::entity RequireButton(ui::Result<ui::EntityHandle> result, std::string_view alias)
{
    if (!result)
    {
        ui::log::Error("Failed to create button '{}': {}", alias, result.error().ToString());
...
inline ui::entity MakeSectionTitle(const std::string& text, const std::string& alias)
{
    ...
    lbl | TextColor({1.0F, 0.85F, 0.5F, 1.0F}) | FontSize(14.0F) |
        SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_FIXED) | Size(0.0F, 22.0F) |
...
inline ui::entity MakeImageCard(std::string_view title, std::string_view assetFileName, const std::string& alias)
{
    ...
    label | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_FIXED) | Size(0.0F, 18.0F) |
...
{
    auto gameWindowResult = ui::factory::CreateWindow("UI Controls Demo", "gameWindow");
    if (!gameWindowResult)
    {
        ui::log::Error("Failed to create main window: {}", gameWindowResult.error().ToString());
        return;
    }
    const auto gameWindow = gameWindowResult->raw;
    ...
    row1 | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_FIXED) | Size(0.0F, 340.0F) | Spacing(8.0F);
...

    {
        ...
        btnRow | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_FIXED) | Size(0.0F, 32.0F) |
            Spacing(5.0F);

        auto primaryBtn = detail::RequireButton(ui::factory::CreateButton("Primary", "primaryBtn"), "primaryBtn");
        ...
        auto warnBtn = detail::RequireButton(ui::factory::CreateButton("Warning", "warnBtn"), "warnBtn");
        ...
        auto dangerBtn = detail::RequireButton(ui::factory::CreateButton("Danger", "dangerBtn"), "dangerBtn");
        ...
        auto ghostBtn = detail::RequireButton(ui::factory::CreateButton("Ghost", "ghostBtn"), "ghostBtn");
        ...
        auto disabledBtn = detail::RequireButton(ui::factory::CreateButton("Disabled", "disabledBtn"), "disabledBtn");
        ...
        cbRow | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_FIXED) | Size(0.0F, 26.0F) |
            Spacing(10.0F);
        ...
        {
            cbEnt | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_EXPANDING) | BorderRadius(3.0F);
        }
        ...
        lineEdit | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_FIXED) | Size(0.0F, 30.0F) |
        ...
        pwdEdit | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_FIXED) | Size(0.0F, 30.0F) |
            BackgroundColor({0.15F, 0.15F, 0.18F, 0.95F}) | BorderRadius(4.0F) |
            BorderColor({0.35F, 0.35F, 0.42F, 1.0F}) | BorderThickness(1.0F) | Padding(6.0F) | FontSize(13.0F) |
        ...
        multiEdit | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_FIXED) | Size(0.0F, 68.0F) |
        ...
        progressBar | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_FIXED) | Size(0.0F, 16.0F) |
        ...
        hSlider | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_FIXED) | Size(0.0F, 22.0F) |
        ...
        vRow | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_FIXED) | Size(0.0F, 36.0F) | Spacing(6.0F);
...

    {
        ...
        canvasPanel | panelStyle | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_EXPANDING);
        ...
        canvas | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_EXPANDING) |
    ...
    row2 | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_EXPANDING) | Spacing(8.0F);
    gameWindow | AddChild(row2);

    {
        auto tablePanel = ui::factory::CreateVBoxLayout("tablePanel");
        tablePanel | panelStyle | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_EXPANDING);
        ...
        dataTable | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_EXPANDING) |
        ...
        auto banBtn0 = detail::RequireButton(ui::factory::CreateButton("Ban", "banBtn0"), "banBtn0");
        ...
        auto banBtn1 = detail::RequireButton(ui::factory::CreateButton("Ban", "banBtn1"), "banBtn1");
...

    {
        ...
        scrollPanel | panelStyle | Size(320.0F, 0.0F) |
            SizePolicy(ui::policies::Size::H_FIXED | ui::policies::Size::V_EXPANDING);
        ...
        scrollArea | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_EXPANDING) |
        ...
        scrollContent | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_AUTO) | Spacing(3.0F);
        ...
        for (int i = 1; i <= 20; ++i)
        {
            ...
            item | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_FIXED) | Size(0.0F, 22.0F) |
...

    {
        ...
        supportLabel | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_FIXED) | Size(0.0F, 20.0F) |
            TextAlignment(ui::policies::Alignment::LEFT | ui::policies::Alignment::VCENTER) |
        ...
        imageRow | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_FIXED) | Size(0.0F, 132.0F) |
            Spacing(8.0F);
        ...
        unsupportedLabel | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_FIXED) | Size(0.0F, 34.0F) |
        ...
        auto noteLabel = ui::factory::CreateLabel(
            ...
            "imageNoteLabel");
        noteLabel | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_EXPANDING) |
    ...
    row3 | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_FIXED) | Size(0.0F, 200.0F) | Spacing(8.0F);
    gameWindow | AddChild(row3);

    {
        auto chatPanel = ui::factory::CreateVBoxLayout("chatPanel");
        chatPanel | panelStyle | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_EXPANDING);
        ...
        msgArea | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_EXPANDING) | TextContent(initMsg) |
        ...
        inputRow | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_FIXED) | Size(0.0F, 30.0F) |
            Spacing(5.0F);

        auto chatInput = ui::factory::CreateLineEdit("", "Type a message...", "chatInput");
        auto sendBtn = detail::RequireButton(ui::factory::CreateButton("", "sendBtn"), "sendBtn");
        ...
        chatInput | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_EXPANDING) |
        ...
        sendBtn | Icon("MaterialSymbols", 0xe31b, ui::policies::IconFlag::DEFAULT, 20.0F, 0.0F) |
            SizePolicy(ui::policies::Size::H_FIXED | ui::policies::Size::V_EXPANDING) | Size(40.0F, 0.0F) |
    ...
    row4 | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_FIXED) | Size(0.0F, 160.0F) | Spacing(8.0F);
    gameWindow | AddChild(row4);

    {
        auto animPanel = ui::factory::CreateVBoxLayout("animPanel");
        animPanel | panelStyle | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_EXPANDING);
        ...
        demoRow | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_EXPANDING) | Spacing(10.0F);
        ...
        // --- 1. Alpha (淡入 / 淡出) ---
        {
            ...
            box | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_FIXED) | Size(0.0F, 48.0F) |
            ...
            btnRow | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_FIXED) | Size(0.0F, 26.0F) |
                Spacing(4.0F);

            auto fadeOutBtn =
                detail::RequireButton(ui::factory::CreateButton("淡出", "animFadeOutBtn"), "animFadeOutBtn");
            fadeOutBtn | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_EXPANDING) |
            ...
            auto fadeInBtn =
                detail::RequireButton(ui::factory::CreateButton("淡入", "animFadeInBtn"), "animFadeInBtn");
            fadeInBtn | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_EXPANDING) |
                BackgroundColor({0.20F, 0.50F, 0.85F, 1.0F}) | BorderRadius(3.0F) | FontSize(11.0F) |
                OnClick(
                    [box]()
                    {
        ...
        // --- 2. Slide (RenderOffset 左右滑动) ---
        {
            ...
            auto leftBtn =
                detail::RequireButton(ui::factory::CreateButton("← 左移", "animSlideLeftBtn"), "animSlideLeftBtn");
            leftBtn | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_EXPANDING) |
            ...
            auto rightBtn =
                detail::RequireButton(ui::factory::CreateButton("右移 →", "animSlideRightBtn"), "animSlideRightBtn");
            rightBtn | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_EXPANDING) |
                BackgroundColor({0.20F, 0.65F, 0.40F, 1.0F}) | BorderRadius(3.0F) | FontSize(11.0F) |
                OnClick(
                    [box]()
                    {
        ...
        // --- 3. Scale (放大 / 缩小) ---
        {
            ...
            auto upBtn =
                detail::RequireButton(ui::factory::CreateButton("放大", "animScaleUpBtn"), "animScaleUpBtn");
            upBtn | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_EXPANDING) |
            ...
            auto downBtn =
                detail::RequireButton(ui::factory::CreateButton("缩小", "animScaleDownBtn"), "animScaleDownBtn");
            downBtn | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_EXPANDING) |
                BackgroundColor({0.70F, 0.35F, 0.80F, 1.0F}) | BorderRadius(3.0F) | FontSize(11.0F) |
                OnClick(
                    [box]()
                    {
        ...
        // --- 4. Color (颜色渐变) ---
        {
            ...
            auto toBlueBtn =
                detail::RequireButton(ui::factory::CreateButton("→蓝", "animColorBlueBtn"), "animColorBlueBtn");
            toBlueBtn | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_EXPANDING) |
            ...
            auto toOrangeBtn =
                detail::RequireButton(ui::factory::CreateButton("→橙", "animColorOrangeBtn"), "animColorOrangeBtn");
            toOrangeBtn | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_EXPANDING) |
                BackgroundColor({0.85F, 0.45F, 0.15F, 1.0F}) | BorderRadius(3.0F) | FontSize(11.0F) |
                OnClick(
                    [box]()
                    {
        ...
        // --- 5. Loop (循环闪烁) ---
        {
            ...
            auto startBtn =
                detail::RequireButton(ui::factory::CreateButton("播放", "animLoopStartBtn"), "animLoopStartBtn");
            startBtn | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_EXPANDING) |
            ...
            auto stopBtn =
                detail::RequireButton(ui::factory::CreateButton("停止", "animLoopStopBtn"), "animLoopStopBtn");
            stopBtn | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_EXPANDING) |
        ...
        // --- 6. PingPong (呼吸缩放) ---
        {
            ...
            auto startBtn = detail::RequireButton(ui::factory::CreateButton("播放", "animPingPongStartBtn"),
                                                  "animPingPongStartBtn");
            startBtn | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_EXPANDING) |
            ...
            auto stopBtn = detail::RequireButton(ui::factory::CreateButton("停止", "animPingPongStopBtn"),
                                                 "animPingPongStopBtn");
            stopBtn | SizePolicy(ui::policies::Size::H_EXPANDING | ui::policies::Size::V_EXPANDING) |
